            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="flex flex-row flex-wrap  p-6">
                    ...
                    <div class="flex-1 px-3 space-y-6">
                        ...
                        <div class="mb-6">
                                <label for="file"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">File</label>
                                <div class="bg-gray-200 w-full mb-2">
                                    <img id="file-imgs" class="h-20 mx-auto" src="" alt="" srcset="">
                                </div>
                                <input
                                    onchange="document.getElementById('file-imgs').src = window.URL.createObjectURL(this.files[0])"
