<div class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full" id="modal-add-letter">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-center p-5 rounded-t border-b dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="modal-add-letter">
            ...
            <form action="{{route('letter.create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex-1 px-3 space-y-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="perihal" name="perihal"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary"
                                placeholder="contoh: Pemohonan Ijin Kunjungan Kerja Industri" value="" required>
                        </div>
                        <div class="mb-6">
                            <label for="sifat"
                ...
                <div class="flex justify-end p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                    <button id="btn-add-letter" type="submit"
                    ...
                    <button data-modal-toggle="modal-add-letter" type="button"
