<ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
    ...
    <li>
        <button type="button" class="flex items-center w-full p-1 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-kepegawaian" data-collapse-toggle="dropdown-kepegawaian">
            <i class="ml-1 fa-solid fa-image-portrait text-lg text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"></i>
        ...
        <ul id="dropdown-kepegawaian" class="{{Route::currentRouteName() === 'employee.index' || Route::currentRouteName() === 'employee.detail' || Route::currentRouteName() === 'employee.edit' ? '' : 'hidden'}} py-2 space-y-2">
            <li>
                <a href="{{route('employee.index')}}" class="{{Route::currentRouteName() === 'employee.index' || Route::currentRouteName() === 'employee.detail' || Route::currentRouteName() === 'employee.edit' ? 'border-l-8 border-l-primary bg-gray-100 -ml-2' : '' }}
    ...
    <li>
        <a href="#"
            ...
            <i class="fa-solid fa-chalkboard-user text-lg text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></i>
