                ...
                <div class="p-6 space-y-6">
                    <div class="flex flex-row flex-wrap">
                        <div class="flex-1 px-3">
                            ...
                            <div class="mb-6">
                                <label for="lampiran"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Lampiran
                                    (opsional)</label>
                                <input type="text" id="lampiran" name="lampiran"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary"
                                    placeholder="contoh: Surat Pemohonan Kunjungan Industri" value="" required>
                            </div>
                            <div class="mb-6">
                                <label for="perihal"
                            ...
                            <div class="mb-6">
                                <label for="jam"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jam
                                    Kunjungan</label>
                        ...
                        <div class="flex-1 px-3">
                            ...
                            <div class="mb-6">
                                <label for="keterangan"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Keterangan
                                    Kunjungan</label>
                            ...
                            <div class="mb-6">
                                ...
                                <input
                                    onchange="document.getElementById('dokumentasi-imgs').src = window.URL.createObjectURL(this.files[0])"
                                    accept=".jpg, .jpeg, .png, .pdf"
                                    class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                    aria-describedby="dokumentasi_help" id="dokumentasi" type="file" name="dokumentasi">
                                <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="dokumentasi_help">
                                    Maksimal ukuran file: 2mb</div>
                            </div>
                        </div>
                    </div>
                </div>
