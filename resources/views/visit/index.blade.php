...
@section('script')
    ...
    <script>
                ...
                html += `
                        ...
                        <td class="rounded-r-lg py-6 px-6 text-sm text-center font-medium flex-nowrap">
                            <div class="inline-flex" role="group">
                                ...
                                <button type="button"
                                onclick="btnEditVisit('${data.id}', '${data.no_surat}', '${data.lampiran}', '${data.perihal}', '${data.kepada}', '${data.hari }', '${data.tanggal}', '${data.tempat}', '${data.jam}', '${data.jumlah_peserta}', '${data.dokumentasi}', '${data.keterangan}', '${data.status}')"
        ...
        function btnEditVisit(id, no_surat, lampiran, perihal, kepada, hari, tanggal, tempat, jam, jumlah_peserta, dokumentasi, keterangan, status) {
            ...
            $('#modal-edit-visit #hari').val(hari);
