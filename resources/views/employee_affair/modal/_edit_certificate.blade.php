        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-center p-5 rounded-t border-b dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="modal-edit-certificate">
            ...
            <form action="{{route('employee.certificates.update', $employee['id'])}}" method="post" id="form-edit-certificate" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <!-- Modal body -->
                ...
                <div class="p-6 space-y-3">
                    <div class="mb-3">
                        ...
                        <input type="text" id="nama_s" name="nama"
                    ...
                    <div class="mb-3">
                        ...
                        <input name="tanggal" id="tanggal" type="date" value="2011-11-20" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-gray-200 w-full mb-2">
                            <img id="sertifikat-imgs" class="h-36 mx-auto" src="" alt="" srcset="">
                        </div>
                        <input onchange="document.getElementById('sertifikat-imgs').src = window.URL.createObjectURL(this.files[0])"
                ...
                <div class="flex justify-end p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                    <button id="btn-edit-certificate" type="submit"
                    ...
                    <button data-modal-toggle="modal-edit-certificate" type="button"
