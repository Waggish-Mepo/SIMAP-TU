        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="modal-add-agenda">
            ...
            <form action="#" method="post" enctype="multipart/form">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="mb-6">
                        <label for="pimpinan"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pimpinan</label>
                    ...
                    <div class="mb-6">
                        <label for="jml_hadir"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jumlah Hadir</label>
                        <input type="number" min="0" step="10" value="0"  id="jml_hadir" name="jml_hadir"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary"
                            required>
                    </div>
                    <div class="grid grid-cols-10 gap-2 mb-6">
                        <div class="col-span-5">
                            ...
                            <input name="tgl_rapat" id="tgl_kegiatan" datepicker-format="dd/mm/yyyy" type="date" value=""
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Select date">
                        </div>
                        <div class="col-span-5">
                            <label for="waktu_rapat"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Waktu
                                 </label>
                            <input name="waktu_rapat" id="waktu_rapat" type="time" value=""
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Select date">
                        </div>
                    </div>
                    <div class="mb-6">
                        <label for="tempat"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tempat</label>
