...
@section('content')
    <p class="mb-4 text-2xl font-semibold text-gray-800">
        {{ $user->role === 'ADMIN' ? 'Kelola User' : 'Daftar Pegawai' }}
    </p>
        ...
        <ul class="flex flex-wrap -mb-px" id="employeeTab" data-tabs-toggle="#employeeTabContent" role="tablist">
            ...
            <li class="mr-2" role="presentation">
                <button
                    ...
                    id="teacher-tab" data-tabs-target="#teacher" type="button" role="tab" aria-controls="teacher"
                    aria-selected="false">Data Guru</button>
            </li>
            <li class="mr-2" role="presentation">
                <button
                    class="inline-block py-2 px-4 text-sm font-medium text-center text-gray-500 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300"
                    id="staff-tab" data-tabs-target="#staff" type="button" role="tab" aria-controls="staff"
                    aria-selected="false">Data Staf</button>
            </li>
        </ul>
    </div>
    <div id="employeeTabContent">
        <div class="rounded-lg" id="employee" role="tabpanel"
            ...
            <div class="grid justify-items-end mb-4">
                <div class="flex flex-row">
                    ...
                    @endif
                    <a href="{{route('employee.detail', $user->userable_id)}}" class="text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:focus:ring-yellow-900">
        ...
        <div class="hidden rounded-lg" id="teacher" role="tabpanel" aria-labelledby="teacher-tab">
            <div class="grid justify-items-end mb-4">
                <div class="flex flex-row">
                    @if ($user->role === 'ADMIN')
                        <a href="{{route('employee.export.teacher')}}" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            <i class="fa-solid fa-file-export mr-2"></i>
                            Export
                        </a>
                        <button type="button" data-modal-toggle="modal-add-employee" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            ...
            <div class="flex flex-col">
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block py-2 min-w-full sm:px-6 lg:px-8">
                        <div class="overflow-hidden">
                            <table id="table-teacher" class="min-w-full border-separate table-spacing">
                                <thead class="bg-primary dark:bg-primary">
                                    <tr>
                                        <th scope="col"
                                            class="rounded-l-lg py-6 px-6 text-xs font-medium tracking-wider text-left text-white uppercase dark:text-gray-400">
        ...
        <div class="hidden rounded-lg dark:bg-gray-800" id="staff" role="tabpanel"
            aria-labelledby="staff-tab">
            <div class="grid justify-items-end mb-4">
                <div class="flex flex-row">
                    @if ($user->role === 'ADMIN')
                        <a href="{{route('employee.export.staff')}}" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            <i class="fa-solid fa-file-export mr-2"></i>
                            Export
                        </a>
                        <button type="button" data-modal-toggle="modal-add-employee" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            ...
            <div class="flex flex-col">
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block py-2 min-w-full sm:px-6 lg:px-8">
                        <div class="overflow-hidden">
                            <table id="table-staff" class="min-w-full border-separate table-spacing">
                                <thead class="bg-primary dark:bg-primary">
                                    <tr>
                                        <th scope="col"
                                            class="rounded-l-lg py-6 px-6 text-xs font-medium tracking-wider text-left text-white uppercase dark:text-gray-400">
        ...
        function getUsers() {
            ...
            $.ajax({
                ...
                error: function (error) {
                    ...
                    <tr
                        class="border-b odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700 dark:border-gray-600">
                        <td class="rounded-lg py-6 px-6 text-sm font-medium text-center text-gray-900 whitespace-nowrap dark:text-white" colspan="6">
